...
async def cmd_start(message: Message):
    ...
    await message.answer(
        "Привет! Я бот, который может генерировать текст с помощью ChatGPT.\n"
...
async def cmd_help(message: Message):
    await message.answer(
        "Я телеграм-бот, интегрированный с ChatGPT.\n"
        "Отправь мне любое текстовое сообщение, и я сгенерирую ответ.\n"
